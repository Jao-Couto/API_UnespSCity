...
broker.start().then(() => {
    ...
    broker.call("submenu-service.create", { name: "Radar da Dengue", menuId: 5, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Foco de Escorpião", menuId: 5, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Leishmaniose", menuId: 5, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Insetos, roedores, etc...", menuId: 5, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Animais abandonado", menuId: 6, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Animais Perdidos", menuId: 6, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Adoção de animais", menuId: 6, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Adoção de Áreas públicas", menuId: 7, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Coleta de Lixo / Coleta seletiva", menuId: 7, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Locais úteis ao cidadão", menuId: 9, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Telefones Úteis", menuId: 9, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Programação Cultural", menuId: 9, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Túmulos de falecidos", menuId: 9, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Feiras Livres", menuId: 9, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Descarte Solidário", menuId: 10, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Conheça os Gestores", menuId: 13, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Consultar Propostas", menuId: 13, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Notícias", menuId: 14, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Sugestões", menuId: 14, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Rotas dos guardas", menuId: 15, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Trânsito", menuId: 15, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    broker.call("submenu-service.create", { name: "Rota de Veículos", menuId: 15, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
    ...
    broker.call("submenu-service.create", { name: "Ofertas Locais", menuId: 16, logo: '../../assets/Icones/home_controle_pragas.png', type: "Solicitacao" });
