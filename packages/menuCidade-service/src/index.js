...
broker.start().then(() => {
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 1 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 2 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 3 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 4 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 5 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 6 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 7 });
    broker.call("menucidade-service.create", { cityId: 3541406, menuId: 8 });
