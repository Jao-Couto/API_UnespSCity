...
broker.start().then(() => {
  ...
  broker.call("menucidade-service.create", { cityId: 3, menuId: 1 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 2 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 3 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 4 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 5 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 6 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 7 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 8 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 9 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 10 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 11 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 12 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 13 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 14 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 15 });
  broker.call("menucidade-service.create", { cityId: 3, menuId: 16 });
