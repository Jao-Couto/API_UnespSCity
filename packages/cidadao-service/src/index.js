...
broker.start().then(() => {
  ...
  broker.call("cidadao-service.create", { name: "João Silva", email: "joao@gmail.com", password: "senha123", mobilePhone: "18999998886", cityId: 3, panicButton: false, isAdmin: false })
    .then(res => console.log("Cadastrado!"))
    .catch(err => console.error("Error", err));
  broker.repl()
})
