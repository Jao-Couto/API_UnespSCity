...
broker.start().then(() => {
    ...
    broker.call("cidadao-service.create", { name: "admin", email: "admin@admin.com", password: "admin", mobilePhone: "18999999999", cityId: 3541406, panicButton: false, isAdmin: true })
        .then(res => console.log("Cadastrado!"))
        .catch(err => console.error("Error", err));

    broker.call("cidadao-service.create", { name: "José Silva", email: "jose@gmail.com", password: "senha123", mobilePhone: "18999999997", cityId: 3541406, panicButton: true, isAdmin: false })
        .then(res => console.log("Cadastrado!"))
        .catch(err => console.error("Error", err));
